            ...
            <div class="condition">
                ...
                <div class="ordering">
                    <ul>
                        ...
                        <li class="default" @click="change_order_type('id')" :class="change_class('id')">
                            默认
                        </li>
                        <li class="hot" @click="change_order_type('students')" :class="change_class('students')">
                            人气
                        </li>
                        <li class="price" @click="change_order_type('price')" :class="change_class('price')">
                            价格
                        </li>
                    </ul>
